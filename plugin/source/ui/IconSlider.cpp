...
IconSlider::IconSlider(juce::AudioProcessorValueTreeState &apvts, const juce::String &parameterID, SVGData svg)
...
void IconSlider::setSliderStyle(juce::Slider::SliderStyle style)
{
